      ...
      <div className="max-w-7xl mx-auto space-y-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-mono font-bold tracking-widest uppercase bg-red-950/80 border border-amber-500/40 text-amber-300">
            ...
            <span>• 3D ARSENAL OF MUSIC & LIVING WISDOM</span>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {NOVA_LORE.weapons.filter(w => w.id !== 'astrolabe_codex').map((w) => (
            <button
              ...
              className={`px-6 py-3.5 rounded-2xl font-bold text-xs uppercase tracking-wider transition-all duration-300 flex items-center gap-2.5 border font-serif ${activeWeapon === w.id
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {NOVA_LORE.dimensionsSaved.map((dim, idx) => (
              <div
                ...
                className={`p-5 rounded-2xl border transition-all cursor-pointer text-left flex flex-col justify-between ${activeDimension === idx
          ...
          <div className="max-w-3xl space-y-4 relative z-10">
            ...
            <div className="pt-6 flex flex-wrap items-center gap-4">
              ...
              >
                ...
                <span>• OPEN AI HELP PORTAL (CHAT)</span>
